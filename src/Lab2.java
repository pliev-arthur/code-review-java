...
// FIXTO:
/**
 * Точка входа для лабораторной работы №2 (вариант 7).
 *
 * <p>Запускает интерактивное меню, принимающее от пользователя номер задачи
 * в формате {@code <задание>.<задача>} (например, {@code 1.3}) и выполняющее
 * соответствующую задачу. Ввод {@code 0} завершает программу.
 */
...
public class Lab2 {
    ...
    private void runTask5_4() {
        ...
        Time time2 = new Time(4532);
        Time time3 = new Time(123);
        System.out.println(time1.getCurrentHours());
        System.out.println(time2.getCurrentMinutes());
        System.out.println(time3.getCurrentSeconds());
    }
}